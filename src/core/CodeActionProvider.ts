...
export const ACTION_NAMES = {
	EXPLAIN: "Cline: Explain Code",
	FIX: "Cline: Fix Code",
	FIX_LOGIC: "Cline: Fix Logic",
	IMPROVE: "Cline: Improve Code",
	ADD_TO_CONTEXT: "Cline: Add to Context",
} as const

export const COMMAND_IDS = {
	EXPLAIN: "cline.explainCode",
	FIX: "cline.fixCode",
	IMPROVE: "cline.improveCode",
	ADD_TO_CONTEXT: "cline.addToContext",
} as const

export class CodeActionProvider implements vscode.CodeActionProvider {
	public static readonly providedCodeActionKinds = [vscode.CodeActionKind.QuickFix, vscode.CodeActionKind.RefactorRewrite]
	...
	public provideCodeActions(
		...
		try {
			...
			actions.push(
				...this.createActionPair(ACTION_NAMES.IMPROVE, vscode.CodeActionKind.RefactorRewrite, COMMAND_IDS.IMPROVE, [
					filePath,
					effectiveRange.text,
				]),
			)
			...
			actions.push(
				this.createAction(ACTION_NAMES.ADD_TO_CONTEXT, vscode.CodeActionKind.QuickFix, COMMAND_IDS.ADD_TO_CONTEXT, [
					filePath,
					effectiveRange.text,
				]),
			)
